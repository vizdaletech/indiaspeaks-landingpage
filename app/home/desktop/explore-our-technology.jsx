    ...
    <section className="center-section hidden md:block">
      ...
      <div className="flex relative">
            ...
            <div className="gap-5 flex">
              <div className="flex flex-col items-start w-full">
                ...
                >
                  ...
                  />
                  <div className="text-neutral-900 text-base leading-6 self-stretch grow whitespace-nowrap" ref = {section2}>
                    {/* Tailored */}
                    Innovative
                  </div>
                </div>
                ...
                >
                  ...
                  text technology. Reflecting the true essence of human speech,
                  this is beyond mere transcription. <br />
                </p>
              </div>
            </div>
          </div>
        ...
        <div className={`flex flex-col items-stretch w-full ml-5 max-md:w-full max-md:ml-0 ${activeRow === "one" ? "opacity-1 z-20" : "opacity-0 -z-20" } transition-all duration-300 absolute top-0 left-0`}>
          ...
          <div className={`flex flex-col items-stretch w-full ml-5 max-md:w-full max-md:ml-0 ${activeRow === "three" ? "opacity-1 z-20" : "opacity-0 -z-20" } absolute top-0 left-0`}>
              <Image
