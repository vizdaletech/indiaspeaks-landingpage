...
function PersonalisedPoliticalSectionMobile() {
  return (
    ...
    <div className="items-stretch center-section bg-violet-100 flex  w-full flex-col mx-auto pl-3 pr-5 py-6 rounded-lg">
      <img loading="lazy" alt = "image" src="https://cdn.builder.io/api/v1/image/assets/TEMP/eeb0aed248de35e84c34f73918bdcefa6b711262d1387bba193463940ec443a8?apiKey=b5e5f0f3194e4a2bbb3631aa331ddab2&" className="aspect-[0.89] object-contain object-center w-full overflow-hidden" />
