...
const Ribbon = () => {
  return (
    <section className='hidden md:block bg-primary '>
      ...
      <div className="items-stretch flex justify-between gap-5 px-4 py-3 max-md:max-w-full max-md:flex-wrap max-md:mr-1">
        <div className="items-center flex justify-between gap-4 max-md:max-w-full max-md:flex-wrap">
          <img
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/b61a5502c0041b058c1d39fa368a3bb5a5ab5c989b9aa024527bdf1c4190b030?"
        ...
        <div className="text-black text-base leading-6 whitespace-nowrap justify-center items-stretch border bg-secondary self-center my-auto px-5 py-2 border-solid border-secondary">
