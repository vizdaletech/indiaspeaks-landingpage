  ...
  return (
    ...
    <div className="justify-center center-section items-stretch  flex  flex-col">
      ...
      <Link href = "/" className="block mr-auto">
        ...
        <a href = "tel:+917010389351" className="text-white text-base leading-7 self-stretch mt-1.5">+91 70103 89351</a>
        <a href = "mailto:info@indiaspeaks.ai" className="text-white text-base leading-7 self-stretch mt-1.5">info@indiaspeaks.ai</a>
        ...
        <a href = "https://calendly.com/gomanirajan/30min" target="_blank" rel = "noreferrer" className="text-white text-base font-semibold leading-6 self-stretch mt-5">Contact us</a> 
